...
// Wi-Fi credentials
const char* ssid = "Yann's iPhone";             //nama Wi-Fi anda (SSID)
const char* password = "22September2005";     //password Wi-Fi anda

// Firebase credentials
#define API_KEY "AIzaSyALglseDWfP1OTTue13-jmrYV5xQ5LwO90"              //Found in Project Settings > General
#define DATABASE_URL "https://internet-of-things-3e552-default-rtdb.asia-southeast1.firebasedatabase.app"   //From Realtime Database URL
#define USER_EMAIL "capriansitepu2005@gmail.com"    //email user saat membuat database
#define USER_PASSWORD "sitepu220905"            //password user yang telah didaftarkan
